...
function filterByDuration(list, low, high) {
  ...
  // let advByDuration=list.filter((adv)=>{
  //   if (adv.duration>=low && adv.duration<=high){
  //     return true  
  //     // return adv 
  //   }
...
function filterByCategory(list, categoryList) {
  ...
  //     return category===adv.category
  //   }))
  //   advByCategory.push(adv)
  // })
  // return advByCategory

  // let advByCategory=list.filter((adv)=>{
...
function filterFunction(list, filters) {
  ...
  if (filters.duration.length!==0 && filters.category.length===0){
    ...
    // using for loops to match the ids of the adventures got by filterByDuration and filterByCategory functions and return a list of adventures having common ids
    // let filteredAdvs=[]
    //   for (let i=0; i<filByDuration.length; i++){
    //     for (let j=0; j<filByCategory.length; j++){
    //       if (filByDuration[i].id===filByCategory[j].id){
    //         filteredAdvs.push(filByDuration[i])
    //       }
    //     }
    //   }
